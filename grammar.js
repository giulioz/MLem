...
var grammar = {
    ...
    {"name": "exp", "symbols": ["tuple"], "postprocess": nth(0)},
    {"name": "exp2", "symbols": ["value"], "postprocess": nth(0)},
    {"name": "exp2", "symbols": ["ident"], "postprocess": d => ({type: "ident", name: d[0]})},
    {"name": "exp2", "symbols": ["lambda"], "postprocess": nth(0)},
    {"name": "exp2", "symbols": ["app"], "postprocess": nth(0)},
    {"name": "exp2", "symbols": ["parens"], "postprocess": nth(0)},
    {"name": "exp2", "symbols": ["let"], "postprocess": nth(0)},
    {"name": "exp2", "symbols": ["type"], "postprocess": nth(0)},
    ...
    {"name": "let", "symbols": ["let$string$1", "__", "ident", "_", {"literal":"="}, "_", "exp", "sep", "exp"], "postprocess": d => ({type: "let", ident: d[2], value: d[6], in: d[8]})},
    ...
    {"name": "tuple", "symbols": ["exp2", "_", {"literal":","}, "_", "exp2"], "postprocess": d => ({type: "tuple", items: [d[0], d[4]]})},
    {"name": "tuple", "symbols": ["exp2", "_", {"literal":","}, "_", "tuple"], "postprocess": d => ({type: "tuple", items: [d[0], ...d[4].items]})},
